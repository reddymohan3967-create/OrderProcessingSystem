# Design Patterns Implemented — Reference Document

A concise reference document. Each entry lists where the pattern is used in the repo (relative paths / classes) and key information.
...
- Trade-offs: complexity and storage vs. reliability and recoverability.
- How idempotency and outbox together provide practical exactly-once semantics for this architecture.
- Alternatives: distributed transactions, broker-side exactly-once and considerations why outbox + idempotency is commonly chosen.

---

File created in project: `docs/Design Patterns Implemented.md`
